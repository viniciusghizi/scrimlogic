...
- **Processamento:** Implementação do `ScrimBatchProcessor` para ETL de arquivos JSON (LoL e RL).
...
*Esta é a versão de lançamento oficial do sistema de ingestão de partidas.*